"""Alembic migration environment for Cyphergy.

Supports both synchronous (offline) and asynchronous (online) migration
execution. DATABASE_URL is sourced from the environment (CPAA-compliant).
"""
...
# ---------------------------------------------------------------------------
# CPAA: Override sqlalchemy.url from DATABASE_URL environment variable
# ---------------------------------------------------------------------------
...
async def run_async_migrations() -> None:
    ...
    Creates an async engine from the configuration and runs migrations

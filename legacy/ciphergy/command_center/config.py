...
class Config:
    ...
    CASE_DIR = os.environ.get("CIPHERGY_CASE_DIR", "/Users/bopennington/LEGAL 2026 Pro Se/CAMPENNI_CASE")

    # Ciphergy product directory
    PRODUCT_DIR = os.environ.get("CIPHERGY_PRODUCT_DIR", "/Users/bopennington/LEGAL 2026 Pro Se/CIPHERGY")
